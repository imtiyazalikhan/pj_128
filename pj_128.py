...
headers = ["name", "light_years_from_earth", "star_mass", "stellar_magnitude", "discovery_date", "hyperlink", 
            "star_type", "star_radius", "orbital_radius", "orbital_period", "eccentricity"]
